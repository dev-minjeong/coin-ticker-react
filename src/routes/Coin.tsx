    ...
    <Container>
      ...
      {loading ? (
        ...
        <CoinInfo>
          <Box>
            <InfoList>
              <InfoKey>RANK:</InfoKey>
              <InfoValue>{infoData?.rank}</InfoValue>
            </InfoList>
            <InfoList>
              <InfoKey>SYMBOL:</InfoKey>
              <InfoValue>${infoData?.symbol}</InfoValue>
            </InfoList>
            <InfoList>
              <InfoKey>PRICE:</InfoKey>
              <InfoValue>${tickersData?.quotes.USD.price.toFixed(2)}</InfoValue>
            </InfoList>
          </Box>
          <Description>{infoData?.description}</Description>
          <Box>
            <InfoList>
              <InfoKey>TOTAL SUPPLY:</InfoKey>
              <InfoValue>{tickersData?.total_supply}</InfoValue>
            </InfoList>
            <InfoList>
              <InfoKey>MAX SUPPLY:</InfoKey>
